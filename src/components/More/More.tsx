...
function More(){
  return(
    <div className="col-span-1 flex flex-col md:grid md:grid-cols-2 md:ml-40 md:mr-20 mb-20">
      ...
      <div className="col-span-1 flex justify-items-center items-center">
        <img className="w-3/5 md:w-4/5 mx-auto md:ml-auto md:mr-0" src={Art1} alt="Art1"/>
      </div>
    </div>
  );
}
